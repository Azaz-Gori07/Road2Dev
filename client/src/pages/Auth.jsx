...
// ── Social button ──
function SocialBtn({ children, label, onClick, disabled }) {
  const [hovered, setHovered] = useState(false);
...
// ── Social row ──
function Socials({ onGoogle, onGitHub, onLinkedIn, disabled }) {
  return (
    <div className={styles.socialRow}>
      <SocialBtn label="Google" onClick={onGoogle} disabled={disabled}>
      ...
      <SocialBtn label="GitHub" onClick={onGitHub} disabled={disabled}>
      ...
      <SocialBtn label="LinkedIn" onClick={onLinkedIn} disabled={disabled}>
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    ...
    <div className={styles.panelContainer}>
      ...
      <div className={styles.authRight}>
        ...
        <Socials
          ...
          onGitHub={onGitHubLogin}
          onLinkedIn={onLinkedInLogin}
