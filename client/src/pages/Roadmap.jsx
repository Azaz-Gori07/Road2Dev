...
const Roadmap = () => {
  ...
  const completed = [ "html", "css", "javascript", "react", "nodejs", "express", "mongodb", "projects", "sql", "php", "mysql", "laravel", "python", "django", "nextjs", "wordpress", "c", "dsa", "cpp"]; // Example completed modules
